...
class VehicleInspection(models.Model):
    ...
    hardware_inspection_disqualification = models.CharField(_("hardware inspection disqualification"), choices = RESULT_OPTION, blank=False, null=False,max_length=30, default="yes")
    no_driver_code_of_conduct = models.CharField(_("no driver code of conduct"), choices = RESULT_OPTION, blank=False, null=False,max_length=30, default="yes")
    overload_or_LSR_violation = models.CharField(_("overload or LSR violation"), choices = RESULT_OPTION, blank=False, null=False,max_length=30, default="yes")
    safety_policy_violation = models.CharField(_("safety policy violation"), choices = RESULT_OPTION, blank=False, null=False,max_length=30, default="yes")
    no_journey_plan_or_log = models.CharField(_("no journey plan or log"), choices = RESULT_OPTION, blank=False, null=False,max_length=30, default="yes")
