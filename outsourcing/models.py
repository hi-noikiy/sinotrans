...
class VehicleInspection(models.Model):
    ...
    rectification_qualified = models.CharField(_("Rectification qualified"), choices = RESULT_OPTION, blank=False, null=False,max_length=30)
    hardware_inspection_disqualification = models.CharField(_("hardware inspection disqualification"), choices = RESULT_OPTION, blank=False, null=False,max_length=30)
